...
public class LlmsTxtGenerator {
    ...
    /**
     * Returns a Markdown absolutePath usable in llms.txt links.
     *
     * @param relativePath Markdown absolutePath relative to the knowledge bundle isRoot
     * @return normalized Markdown absolutePath
     */
