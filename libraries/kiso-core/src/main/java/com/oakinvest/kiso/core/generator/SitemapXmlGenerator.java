...
public class SitemapXmlGenerator {
    ...
    public String generate(final KnowledgeBundle knowledgeBundle) {
        ...
        knowledgeBundle.bundles()
                .flatMap(this::orderedMarkdownFiles)
     ...
     */
    private Stream<MarkdownFile> orderedMarkdownFiles(final Bundle bundle) {
     ...
     */
    private void appendUrl(final StringBuilder content, final MarkdownFile markdownFile) {
        content.append("  <url>\n");
        content.append("    <loc>")
     ...
     * @return HTML path
     */
    private String htmlPath(final Path markdownPath) {
     ...
     * @return timestamp
     */
    private OffsetDateTime timestamp(final MarkdownFile markdownFile) {
